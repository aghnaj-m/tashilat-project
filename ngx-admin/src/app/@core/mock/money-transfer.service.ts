...
export class MoneyTransferService {
  ...
  fetchTransfers() {
    ...
    return this.http.get<Transfer[]>(`http://${this.baseUrl}:8082/transfers/all`)
      .pipe(
        map(resData => {
  ...
  addTransfer(amount: number, receiverFullName: string, receiverPhone: string, date: Date) {
    ...
    return this.authService.user.pipe(take(1), switchMap(user => {
      ...
      return this.http.post<Transfer>(`http://${this.baseUrl}:8082/transfers/save`
        , {
          ...newTransfer,
          id: null,
          server: { id: user.uid },
        ...
        return this.authService.user
          .pipe(
            ...
            switchMap(user => {
              ...
              return this.http.put(`http://${this.baseUrl}:8082/transfers/update/${transferId}`,
